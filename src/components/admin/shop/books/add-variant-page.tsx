...
import { addVariantToBook, getBaseBook } from "@/actions/shop/books/admin-new";
...
export function AddVariantPage({ baseBookId }: AddVariantPageProps) {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    formData.set("baseBookId", baseBookId);
    formData.set("externalLinks", JSON.stringify(externalLinks));

    try {
      const result = await addVariantToBook(formData);
      if (result.message) {
      ...
      <div className="w-full max-w-7xl mx-auto p-6">
        <div className="text-center py-20">
          <p className="text-xl text-muted-foreground mb-4">
            All variants have been added for this book
          </p>
    ...
    <div className="w-full max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Adding a new variant for &quot;{data.book.tittle}&quot;
        </p>
      ...
      >
        <div className="lg:col-span-1">
          <FieldSet>
            <FieldLegend>Variant Cover Image</FieldLegend>
            <FieldDescription>
              Upload a cover image for this variant.
            </FieldDescription>
            <div className="mt-4">
                ...
                {imagePreview ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Click below to upload a cover image
                      </p>
                    </div>
                    <Button
                      type="button"
        ...
        <div className="lg:col-span-1 space-y-6 bg-white rounded-lg p-6">
          ...
          <FieldSet>
            ...
            <FieldDescription>
              Add links to where customers can purchase this variant (Amazon,
              Bookshop.org, etc.)
            </FieldDescription>
